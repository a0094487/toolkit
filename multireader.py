#reads pdf, docx, xlsx and any other files, outputs a datastructure in the form of a dictionary with filename...
...
if filename.endswith('.docx'):
    ...
    try: 
        ...
        print(filename, ' of incompatible file format.') #gives up reading.
print(dataobject)
